...
@app.route('/venues')
def venues():
    all_locations = Venue.query.with_entities(Venue.city, Venue.state).group_by(Venue.city, Venue.state).all()
    areas = []
    venue_data = []
    print(all_locations)
    for location in all_locations:
        matching_venues = Venue.query.filter_by(state=location.state).filter_by(city=location.city).all()
        area = {
          "city": location.city,
...
def edit_artist(artist_id):
    ...
    return render_template('forms/edit_artist.html', form=form, artist=artist_load)
...
def edit_venue(venue_id):
    ...
    return render_template('forms/edit_venue.html', form=form, venue=venue_load)
...
def create_show_submission():
  ...
  try:
    create_show = Show(artist_id=artist_id, venue_id=venue_id, start_time=start_time)
